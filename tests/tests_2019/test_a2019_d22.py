...
@pytest.mark.parametrize(
    "current_card_position, total_num_cards, expected_new_position",
...
def test_dealing_into_new_stack_reverses_cards(
    ...
    new_position = shuffle.new_card_position(current_card_position, total_num_cards)
    assert new_position == expected_new_position


@pytest.mark.parametrize(
    "num_cards_to_cut, current_card_position, total_num_cards, expected_new_position",
...
@pytest.mark.parametrize(
    "increment, current_card_position, total_num_cards, expected_new_position",
    [(1, 2, 1234, 2), (3, 7, 10, 1)],
)
